  ...
  try {
    ...
    while (maxIterations > 0) {
        ...
        if (contentLower.includes('"tool"') && contentLower.includes('"params"')) {
          try {
            ...
            if (parsed.tool && parsed.params) {
              ...
              if (['query_inventory', 'select_inventory', 'query_owner_stock_summary'].includes(toolName) && effectiveOwnerId) {
      ...
      for (const toolCall of toolCalls) {
        ...
        if (['query_inventory', 'select_inventory', 'query_owner_stock_summary'].includes(name) && effectiveOwnerId) {
