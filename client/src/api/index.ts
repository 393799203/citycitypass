...
export const productApi = {
  ...
  getSubCategories: (params?: { categoryId?: string }) => api.get('/products/sub-categories', { params }),
  getSubCategoryOptions: (subCategoryId: string) => api.get(`/products/sub-categories/${subCategoryId}/options`),
  ...
  createSubCategory: (data: any) => api.post('/products/sub-categories', data),
  updateSubCategory: (id: string, data: any) => api.put(`/products/sub-categories/${id}`, data),
  deleteSubCategory: (id: string) => api.delete(`/products/sub-categories/${id}`),
  ...
  createSubCategorySpec: (data: any) => api.post('/products/sub-category-specs', data),
  deleteSubCategorySpec: (subCategoryId: string, specId: string) => api.delete(`/products/sub-category-specs/${subCategoryId}/${specId}`),
  createSubCategoryPackaging: (data: any) => api.post('/products/sub-category-packagings', data),
  deleteSubCategoryPackaging: (subCategoryId: string, packagingId: string) => api.delete(`/products/sub-category-packagings/${subCategoryId}/${packagingId}`),
...
export const stockApi = {
  ...
  getOwnerStockSummary: () => api.get('/stock/owner-stock-summary'),
