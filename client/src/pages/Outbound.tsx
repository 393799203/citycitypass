...
import { Order, PickOrder, AISuggestion, TooltipContent } from './types';
import PendingOrdersTab from './components/PendingOrdersTab';
import WavePickingTab from './components/WavePickingTab';
import OutboundReviewTab from './components/OutboundReviewTab';
...
请返回JSON格式的推荐分组，每个分组内的订单必须在同一仓库：
{
  "groups": [
    {
      "reason": "推荐理由，如：这两个订单都在企管通1号仓，商品都在RV-R001货架，可以一次性拣完",
